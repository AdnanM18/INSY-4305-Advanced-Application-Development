...
class CreateLoginForm extends JFrame implements ActionListener
{
    ...
    CreateLoginForm()
    {
        ...
        Icon logo = new ImageIcon("assets/user-login-305.png");
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        try (Scanner scanner = new Scanner(new File("users.txt"))) {
            while (scanner.hasNextLine()) {
                ...
                if (parts.length == 2 && parts[0].equals(userValue) && parts[1].equals(passValue)) {
                    isSuccess = true;
                    break;
                }
            }
            ...
            JOptionPane.showMessageDialog(
                    this,
                    "No account file was found. Please create an account first."
            );
            return;
        }
